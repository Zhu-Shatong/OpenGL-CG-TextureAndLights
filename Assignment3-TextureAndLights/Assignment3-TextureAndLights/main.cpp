...
/************************************************************************************************************/
    ...
    glBindBuffer(GL_ARRAY_BUFFER, VBO); // 与Cube的VBO绑定相同的VBO，因为数据相同
...
/************************************************************************************************************/
    ...
    unsigned int brickwall = loadTexture("resources/textures/brickwall.jpg");
    unsigned int metal = loadTexture("resources/textures/metal.png");
...
/************************************************************************************************************/
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("pointLights[1].ambient", 0.00f, 0.05f, 0.00f);
        lightingShader.setVec3("pointLights[1].diffuse", 0.0f, 0.8f, 0.0f);
        lightingShader.setVec3("pointLights[1].specular", 0.0f, 1.0f, 0.0f);
        lightingShader.setFloat("pointLights[1].constant", 1.0f);
        lightingShader.setFloat("pointLights[1].linear", 0.09f);
        lightingShader.setFloat("pointLights[1].quadratic", 0.032f);
        // point light 3
        lightingShader.setVec3("pointLights[2].position", pointLightPositions[2]);
        lightingShader.setVec3("pointLights[2].ambient", 0.00f, 0.00f, 0.05f);
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            glBindTexture(GL_TEXTURE_2D, 0); // Unbind texture from GL_TEXTURE0
            glActiveTexture(GL_TEXTURE1);
            glBindTexture(GL_TEXTURE_2D, 0); // Unbind texture from GL_TEXTURE1
            ...
            if (i < 4) {
                ...
                lightingShader.setFloat("material.shininess", 800.0f);
                glActiveTexture(GL_TEXTURE0);
        ...
        for (unsigned int i = 0; i < 4; i++)
        {
            ...
            lightCubeShader.setVec4("lightColor", customColor[i]);
